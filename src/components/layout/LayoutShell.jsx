...
//         <div className={`hidden h-full overflow-y-auto lg:flex lg:flex-col ${rightWidthClass} transition-all duration-300 ease-in-out`}>
//           {right}
//         </div>
//       </div>
//     </div>
...
const LayoutShell = ({ left, main, leftCollapsed = false }) => {
  ...
  return (
    <div className="min-h-screen bg-[#1a222f] text-slate-100">
      <div className="flex h-full min-h-screen flex-col md:flex-row">
        ...
        <div className="flex-1 overflow-hidden flex flex-col bg-[#1e293b]">
          {main}
        </div>
